...
/**
 * LeonStat_Statistical
 *
 * @category	PHPExcel
 * @package		LeonStat
 * @copyright	Copyright (c) 2006 - 2010 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
require_once 'trendClass.php';
require_once 'MathTrig.php';
...
class LeonStat {
	...
	public static function _checkTrendArrays(&$array1,&$array2) {
	 ...
	 */
	public static function _beta($p, $q) {
	 ...
	 */
	public static function _incompleteBeta($x, $p, $q) {
		if ($x <= 0.0) {
			return 0.0;
		} elseif ($x >= 1.0) {
			return 1.0;
	...
	public static $_logBetaCache_p			= 0.0;
	public static $_logBetaCache_q			= 0.0;
	public static $_logBetaCache_result	= 0.0;
	 ...
	 *	@author Jaco van Kooten
	 */
	public static function _logBeta($p, $q) {
	 ...
	 *	@author Jaco van Kooten
	 */
	public static function _betaFraction($x, $p, $q) {
		$c = 1.0;
		$sum_pq = $p + $q;
		$p_plus = $p + 1.0;
		$p_minus = $p - 1.0;
	...
	public static $_logGammaCache_result	= 0.0;
	public static $_logGammaCache_x		= 0.0;

	public static function _logGamma($x) {
	...
	//
	//	public implementation of the incomplete Gamma function
	//
	...
	//
	//	public implementation of the Gamma function
	//
	...
	public static function _inverse_ncdf($p) {
		...
		return LeonStat::NULL();
	}	//	function _inverse_ncdf()


	public static function _inverse_ncdf2($prob) {
	...
	public static function _inverse_ncdf3($p) {
	 ...
	 *	@return	float
	 */
	public static function AVEDEV($array) {
		$aArgs = $array;
		...
		if ($aMean != LeonStat::DIV0()) {
			$aCount = 0;
			foreach ($aArgs as $k => $arg) {
				// if ((is_bool($arg)) &&
					// ((!LeonStat::isCellValue($k)) || (LeonStat::getCompatibilityMode() == LeonStat::COMPATIBILITY_OPENOFFICE))) {
					// $arg = (integer) $arg;
				// }
	 ...
	 *	@return	float
	 */
	public static function AVERAGEA($array) {
		// Return value
		$returnValue = null;
	...
	public static function AVERAGEIF($aArgs,$condition,$averageArgs = array()) {
		...
		$aArgs = LeonStat::flattenArray($aArgs);
		$averageArgs = LeonStat::flattenArray($averageArgs);
	...
	public static function BETADIST($value,$alpha,$beta,$rMin=0,$rMax=1) {
		$value	= LeonStat::flattenSingleValue($value);
		$alpha	= LeonStat::flattenSingleValue($alpha);
		$beta	= LeonStat::flattenSingleValue($beta);
		$rMin	= LeonStat::flattenSingleValue($rMin);
		$rMax	= LeonStat::flattenSingleValue($rMax);
	...
	public static function BETAINV($probability,$alpha,$beta,$rMin=0,$rMax=1) {
		$probability	= LeonStat::flattenSingleValue($probability);
		$alpha			= LeonStat::flattenSingleValue($alpha);
		$beta			= LeonStat::flattenSingleValue($beta);
		$rMin			= LeonStat::flattenSingleValue($rMin);
		$rMax			= LeonStat::flattenSingleValue($rMax);
		...
		if ((is_numeric($value)) && (is_numeric($trials)) && (is_numeric($probability))) {
			...
			if ((is_numeric($cumulative)) || (is_bool($cumulative))) {
				if ($cumulative) {
					$summer = 0;
					for ($i = 0; $i <= $value; ++$i) {
						$summer += LeonStat_MathTrig::COMBIN($trials,$i) * pow($probability,$i) * pow(1 - $probability,$trials - $i);
					}
					return $summer;
				} else {
					return LeonStat_MathTrig::COMBIN($trials,$value) * pow($probability,$value) * pow(1 - $probability,$trials - $value) ;
				}
			}
		}
		return LeonStat::VALUE();
	...
	public static function CHIDIST($value, $degrees) {
		...
		if ((is_numeric($value)) && (is_numeric($degrees))) {
			...
			if ($value < 0) {
				if (LeonStat::getCompatibilityMode() == LeonStat::COMPATIBILITY_GNUMERIC) {
					return 1;
				}
				return LeonStat::NaN();
			}
	 ...
	 *	@return	int
	 */
	public static function COUNT($aArgs) {
		// Return value
		$returnValue = 0;
	 ...
	 *	@return	int
	 */
	public static function COUNTA($aArgs) {
		// Return value
		$returnValue = 0;
	 ...
	 *	@return	int
	 */
	public static function COUNTBLANK($aArgs ) {
		// Return value
		$returnValue = 0;
...
//			$CumPGuessMinus1 = $CumPGuess - $PGuess;
	 ...
	 *	@return	float
	 */
	public static function DEVSQ($aArgs) {
	 ...
	 *	@return	float
	 */
	public static function GEOMEAN($aArgs) {
	...
	public static function GROWTH($yValues,$xValues=array(),$newValues=array(),$const=True) {
		...
		$newValues = LeonStat::flattenArray($newValues);
		$const	= (is_null($const))	? True :	(boolean) $const;
	 ...
	 *	@return	float
	 */
	public static function HARMEAN($aArgs) {
		// Return value
		$returnValue = LeonStat::NA();
	 ...
	 * @return	float
	 */
	public static function KURT($aArgs) {
	 ...
	 *
	 */
	public static function LARGE($aArgs) {
	...
	public static function LINEST($yValues,$xValues=null,$const=True,$stats=False) {
		$const	= (is_null($const))	? True :	(boolean) $const;
		$stats	= (is_null($stats))	? False :	(boolean) $stats;
		if (is_null($xValues)) $xValues = range(1,count($yValues));
	 ...
	 *	@return	float
	 */
	public static function MAX($aArgs) {
		// Return value
		$returnValue = null;
	 ...
	 *	@return	float
	 */
	public static function MAXA($aArgs ) {
		// Return value
		$returnValue = null;
	 ...
	 *	@return	float
	 */
	public static function MEDIAN($aArgs ) {
		// Return value
		$returnValue = LeonStat::NaN();
	 ...
	 *	@return	float
	 */
	public static function MIN($aArgs) {
		// Return value
		$returnValue = null;
	 ...
	 *	@return	float
	 */
	public static function MINA($aArgs) {
		// Return value
		$returnValue = null;
	...
	//
	public static function _modeCalc($data) {
	 ...
	 *	@return	float
	 */
	public static function MODE($aArgs) {
		// Return value
		$returnValue = LeonStat::NA();
	 ...
	 *	@return	float
	 */
	public static function PERCENTILE($aArgs) {
		// Calculate
	...
	public static function PERCENTRANK($valueSet,$value,$significance=3) {
		...
		$significance	= (is_null($significance))	? 3 :	(integer)  $significance ;
	 ...
	 *	@return	float
	 */
	public static function QUARTILE($aArgs) {
	...
	public static function RANK($value,$valueSet,$order=0) {
		...
		$order	= (is_null($order))	? 0 :	(integer)  $order ;
	 ...
	 * @return	float
	 */
	public static function SKEW($aArgs) {
	 ...
	 *	@return	float
	 */
	public static function SMALL($aArgs) {
	 ...
	 *	@return	float
	 */
	public static function STDEV($dataSet) {
		$aArgs = $dataSet;
	 ...
	 *	@return	float
	 */
	public static function STDEVA($aArgs) {
	 ...
	 *	@return	float
	 */
	public static function STDEVP($aArgs ) {
	 ...
	 *	@return	float
	 */
	public static function STDEVPA($aArgs) {
	 ...
	 *	@return	float
	 */
	public static function TRIMMEAN($aArgs) {
	 ...
	 *	@return	float
	 */
	public static function VARFunc($aArgs) {
		// Return value
		$returnValue = LeonStat::DIV0();
	 ...
	 *	@return	float
	 */
	public static function VARA($aArgs) {
		// Return value
		$returnValue = LeonStat::DIV0();
	 ...
	 *	@return	float
	 */
	public static function VARP($aArgs) {
		// Return value
		$returnValue = LeonStat::DIV0();
	 ...
	 *	@return	float
	 */
	public static function VARPA($aArgs) {
		// Return value
		$returnValue = LeonStat::DIV0();
